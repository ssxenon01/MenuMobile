Ext.define('Menu.controller.Main', {
    ...
    config: {
        ...
        viewCache: [],
        refs: {
            loginWithFbButton: 'button[role=loginWithFB]'
        },
     ...
     * used in a while.
     * @param {String} name The full class name of the view to create (e.g. "Menu.view.Forms")
     ...
     * @param {Menu.model.Demo} item The demo
